...
# routes are mustached, so we'll try to match the object's attributes
# to the attribute names in the route. We'll even recurse into the object
# if needed.
#
# route_name  - String to lookup route in the routes global object
# object      - (optional) Object to feed the routes attributes.
#               If you use routes helper directly and don't pass object it will
